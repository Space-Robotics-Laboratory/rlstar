#RL STaR ![Clover Logo](./media/cloverlogonew.png)
...
Inside the RLSTaR folder:

    >>>.../rlstar$ pip3 install -e .

Installs the necessary packages for RL STaR

Inside the RLSTaR/baselines:

    >>>.../rlstar/baselines$ pip3 install -e .

Installs the necessary packages for baselines
